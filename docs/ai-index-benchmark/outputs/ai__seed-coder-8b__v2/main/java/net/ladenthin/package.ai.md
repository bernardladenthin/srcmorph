...
- T: 2026-06-27T04:59:27Z
- G: 1.0.1-SNAPSHOT
- A: 0.0.0
- X: package
- F: [maven/](maven/package.ai.md)
---
> This package facilitates AI field generation and text generation providers, supporting configuration via prompt templates and AI models, and offering multiple backend integrations including local LLMs and mock implementations.

...
- T: 2026-07-02T22:26:50Z
- G: 1.0.3-SNAPSHOT
- A: 0.0.0
- X: package
- F: [aiindex/](aiindex/package.ai.md)
---
> A Maven plugin that analyses Java source files, selects a suitable LlamaCPP model based on declarative rules, extracts deterministic facts, runs inference via JNI, and returns cleaned AI completions with timing data.
